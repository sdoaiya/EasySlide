...
DOCKER_NAMESPACE = os.getenv("DOCKERHUB_NAMESPACE") or "easyslide"
DOCKER_REPOSITORY = os.getenv("DOCKERHUB_REPOSITORY") or "easyslide"
...
def fetch_docker_hub_tags(namespace: str = DOCKER_NAMESPACE, repository: str = DOCKER_REPOSITORY) -> list[TagInfo]:
    response = requests.get(
        ...
        params={"page_size": 25},
        headers={"User-Agent": "easyslide-updater"},
        timeout=8,
    )

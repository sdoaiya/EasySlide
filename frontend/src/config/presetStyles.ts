...
export const PRESET_STYLES: PresetStyle[] = [
  {
    ...
    previewImage: getStaticAssetUrl('/preset-previews/business-simple.webp'),
    color: '#0B1F3B',
  },
  {
    id: 'tech-modern',
    ...
    previewImage: getStaticAssetUrl('/preset-previews/tech-modern.webp'),
    color: '#7C3AED',
  },
  {
    id: 'academic-formal',
    ...
    previewImage: getStaticAssetUrl('/preset-previews/academic-formal.webp'),
    color: '#7F1D1D',
  },
  {
    id: 'creative-fun',
    ...
    previewImage: getStaticAssetUrl('/preset-previews/creative-fun.webp'),
    color: '#FF6A00',
  },
  {
    id: 'minimalist-clean',
    ...
    previewImage: getStaticAssetUrl('/preset-previews/minimalist-clean.webp'),
    color: '#6B7280',
  },
  {
    id: 'luxury-premium',
    ...
    previewImage: getStaticAssetUrl('/preset-previews/luxury-premium.webp'),
    color: '#F7E7CE',
  },
  {
    id: 'nature-fresh',
    ...
    previewImage: getStaticAssetUrl('/preset-previews/nature-fresh.webp'),
    color: '#14532D',
  },
  {
    id: 'gradient-vibrant',
    ...
    previewImage: getStaticAssetUrl('/preset-previews/gradient-vibrant.webp'),
    color: '#2563EB',
  },
];

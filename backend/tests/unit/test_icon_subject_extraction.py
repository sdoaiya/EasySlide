...
class TestRmbgFactory:
    def test_default_model_path_uses_easyslide_cache(self):
        import services.ai_providers.image.rmbg_segmentation_provider as mod

        assert ".cache" in mod._DEFAULT_MODEL_PATH.parts
        assert "easyslide" in mod._DEFAULT_MODEL_PATH.parts
        assert "banana-slides" not in mod._DEFAULT_MODEL_PATH.parts
